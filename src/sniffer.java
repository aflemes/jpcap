...
public class sniffer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        filter_options.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "TCP", "UDP", "ICMP" }));
    ...
    private void clearButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearButtonActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, "Voce tem certeza que deseja limpar o console?","Warning",dialogButton);
